(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("Smartajax", [], factory);
	else if(typeof exports === 'object')
		exports["Smartajax"] = factory();
	else
		root["Smartajax"] = factory();
})(this, function() {
	...
	*/
	...
	(function (root, factory) {
	    ...
	    if (( false ? 'undefined' : _typeof(exports)) === 'object' && typeof module !== 'undefined') {
	        module.exports = factory(__webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(15), global || root);
	    } else {
	        root.Smartajax = factory(root.toastr, root.alert, root);
	    }
	})(typeof window !== 'undefined' ? window : undefined, function (EventEmitter, Element, Utils, styles, root) {
	    ...
	    var defaultOptions = {},
	        ...
	        createElementsArray = function createElementsArray(selector, filterElements) {
	        var elements = [],
	            i,
	            el;
	        ...
	        Smartajax = function Smartajax(elements, options) {
	    ...
	    Smartajax.prototype.init = function (elements, options) {
	        ...
	        this.options = (typeof options === 'undefined' ? 'undefined' : _typeof(options)) === 'object' ? Utils.extend(defaultOptions, options) : defaultOptions;
	    ...
	    Smartajax.prototype.removeElements = function (selector) {
	        var elements = createElementsArray(selector),
	            i,
	            k;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Toastr = __webpack_require__(11);
	...
	module.exports = function () {
	    ...
	    var resolveFunctionName = function resolveFunctionName(func) {
	        ...
	        camelizeNodeName = function camelizeNodeName(str) {
	        str = str.replace('data-sa-', '').replace(/-/g, ' ');
	        return str.replace(/(?:^\w|[A-Z]|\b\w)/g, function (letter, index) {
	            return index === 0 ? letter.toLowerCase() : letter.toUpperCase();
	        }).replace(/\s+/g, '');
	    },
	        handlerElementAjaxSuccess = function handlerElementAjaxSuccess(saXhr, response) {
	        this.emit('sa:on-ajax-success', saXhr, response);
	    },
	        handlerElementAjaxError = function handlerElementAjaxError(saXhr, response) {
	        this.emit('sa:on-ajax-error', saXhr, response);
	    },
	        handlerElementAjaxComplete = function handlerElementAjaxComplete(saXhr, response) {
	        this.emit('sa:on-ajax-complete', saXhr, response);
	    },
	        handlerElementAjaxAbort = function handlerElementAjaxAbort(saXhr, response) {
	        this.emit('sa:on-ajax-abort', saXhr, response);
	    },
	        handlerElementAjaxTimeout = function handlerElementAjaxTimeout(saXhr, response) {
	        this.emit('sa:on-ajax-timeout', saXhr, response);
	    },
	        bindXhrEvents = function bindXhrEvents() {
	        ...
	        ajaxBeforeSend = function ajaxBeforeSend(dataToSend) {
	        return dataToSend;
	    },
	        ajaxOnSuccess = function ajaxOnSuccess(saXhr, response) {
	        console.log("First on success", response);
	    },
	        ajaxOnError = function ajaxOnError(saXhr, response) {
	        console.log(saXhr, response);
	    },
	        ajaxOnComplete = function ajaxOnComplete(saXhr, response) {
	        //console.log(saXhr, response);
	    },
	        ajaxOnAbort = function ajaxOnAbort(saXhr, response) {
	        //console.log(saXhr, response);
	    },
	        ajaxOnTimeout = function ajaxOnTimeout(saXhr, response) {
	        //console.log(saXhr, response);
	    },
	        bindClassEvents = function bindClassEvents() {
	        ...
	        detatchElementEvents = function detatchElementEvents(element) {
	        if (element.getAttribute('data-sa-request-style') === 'interval') {
	        ...
	        updateElementAttributesToOptions = function updateElementAttributesToOptions() {
	        var attribute,
	            element = this.element,
	        ...
	        prepareAjaxRequestData = function prepareAjaxRequestData() {
	        this.emit('sa:on-ajax-before', this.options.ajaxData);
	    },
	        Element = function Element(element, options) {
	    ...
	    Element.prototype.setOptions = function (opts) {
	        ...
	        this.options = (typeof opts === 'undefined' ? 'undefined' : _typeof(opts)) === 'object' ? Utils.extend(this.options, opts) : this.options;
	        bindClassEvents.call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	module.exports = function () {
	    ...
	    var parseXhrResponse = function parseXhrResponse() {
	        var result;
	        try {
	        ...
	        setupXHROnAbort = function setupXHROnAbort() {
	        this.xhr.onabort = function () {
	            this.emit('onAbort', this.xhr);
	        }.bind(this);
	    },
	        setupXHROnTimeout = function setupXHROnTimeout() {
	        ...
	        setupOnReadyStateChange = function setupOnReadyStateChange() {
	        var xhrResult;
	        ...
	        setupXHRReadyState = function setupXHRReadyState() {
	        this.xhr.onreadystatechange = setupOnReadyStateChange.bind(this);
	    },
	        updateXHROptions = function updateXHROptions() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var utils = __webpack_require__(3);
	var baseNotification = __webpack_require__(6);
	...
	*/
	...
	module.exports = function () {
	    ...
	    var Loader,
	        ...
	        resolveContainer = function resolveContainer(container) {
	        ...
	        createProgressLoader = function createProgressLoader() {},
	        createSpinnerLoader = function createSpinnerLoader() {
	        var overlay,
	            fontAwesome,
	            options = this.getOptions();
	        ...
	        resizeSpinnerLoader = function resizeSpinnerLoader(container, overlay, options, wholePage) {
	        var x, c, size;
	        ...
	        appendLoader = function appendLoader(container, overlay) {
	        ...
	        showLoader = function showLoader(container, overlay) {
	        var i;
	        ...
	        removeLoader = function removeLoader(container) {
	        ...
	        hideLoader = function hideLoader(container) {
	        var i;
	        // TO DO trigger on loader start event
	        if (container instanceof NodeList) {
	            for (i = 0; i < container.length; i = i + 1) {
